...
public class AdamantiteOreGenerator implements IWorldGenerator {
	...
	public AdamantiteOreGenerator(Block block, int chance, int minY, int maxY, int minVien, int maxVien) {
		this.block = block;
		this.chance = chance;
		this.maxY = maxY;
		this.minY = minY;
