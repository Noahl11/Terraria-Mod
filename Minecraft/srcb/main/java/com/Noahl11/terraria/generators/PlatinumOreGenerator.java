...
public class PlatinumOreGenerator implements IWorldGenerator {
	...
	public PlatinumOreGenerator(Block block, int chance, int minY, int maxY, int minVien, int maxVien) {
		this.block = block;
		this.chance = chance;
		this.maxY = maxY;
		this.minY = minY;
